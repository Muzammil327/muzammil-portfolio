    ...
    <>
      <div className="project flex justify-center items-center w-full relative md:py-16 py-8">
        <div className="overflow-hidden rounded-md ">
          ...
          <div className="text py-6 px-3 w-full bg-slate-100">
            ...
            <Link
              ...
              className="ptag flex items-center justify-center bg py-2 px-6 text-white rounded-full text-base hover:bg-black transition-all"
            >
              <span>View</span>
